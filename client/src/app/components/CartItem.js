    ...
    <div className="select-nonr">
      <div className="flex gap-x-4 mb-2">
        ...
        <div className="flex flex-col justify-between">
          {/* remove item */}
          <div onClick={() => removeItem(pizza.ad, pizza.price, pizza.crust)} className="text-2xl flex justify-center items-center self-end cursor-pointer hover:scale-110 duration-100 transition-all text-orange">
            <IoCloseOutline />
          </div>
          {/* price */}
          <div>
